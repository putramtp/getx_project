...
class ProductCategoryController extends GetxController {
  ...
  var filteredOrders = <ProductCategoryModel>[].obs;
  ...
  // Scroll listener
  final ScrollController scrollController = ScrollController(debugLabel:'ProductCategoryController' );
  ...
  Future<void> loadCategories() async {
    ...
    final mapped = rawList.map((e) => ProductCategoryModel.fromJson(e)).toList();
  ...
  Future<void> loadMore() async {
    ...
    final List rawList = res['data'] ?? [];
    final newOrders = rawList.map((e) => ProductCategoryModel.fromJson(e)).toList();
