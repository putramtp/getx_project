...
class StockTransactionDetailView
    extends GetView<StockTransactionDetailController> {
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      title: Text(line.itemName, style: AppTextStyle.h5(size)),
                      ...
                      leading: CircleAvatar(
                        ...
                        child: Icon(Icons.handyman_rounded,
                            color: Colors.indigo, size: size * 1.6),
                      ),
                      trailing: serialNumbers.isEmpty
                          ? const SizedBox.shrink()
                          : IconButton(
                              icon: Icon(Icons.visibility_rounded,
                                  size: size * 2, color: Colors.indigo),
                              onPressed: () {
